...
if __name__ == "__main__":
    ...
    preprocessor_params = {"type": "Center", "arguments": {"center_across": 0}}

    logger_params = [{"type": "LossLogger"}, {"type": "ExplainedVarianceLogger"}]
    ...
    decomposer_params = {
        "type": "CP_ALS",
        "arguments": {"rank": 4, "max_its": 11, "checkpoint_frequency": 2},
        "fit_params": {},
    }
